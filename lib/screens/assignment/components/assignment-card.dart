...
class AssignmentCard extends StatelessWidget {
  ...
  AssignmentCard({this.assignment, this.role});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        Navigator.pushNamed(context, AssignmentDetailPage.routeName, arguments: AssignmentArguments(assignment: assignment, role: role));
      },
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(assignment.title, style: TextStyle(fontSize: 16, letterSpacing: 1.0, fontWeight: FontWeight.w700,),),
